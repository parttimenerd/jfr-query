        ...
        <div ref={containerRef} className="mt-4 border-t border-gray-700 pt-4 animate-fade-in-down flex flex-col space-y-3">
            ...
            <div className="flex-shrink-0 space-y-2">
                ...
                <div className="flex flex-wrap gap-1 items-center">
                    ...
                    <button onClick={() => injectContext('cell content', targetValue)} className="text-[10px] px-2 py-0.5 bg-gray-700/80 hover:bg-gray-600 text-gray-400 hover:text-gray-200 rounded border border-gray-600/60 transition-colors" title={`Inject current ${targetType} content`} aria-label={`Inject current ${targetType} content`}>this {targetType}</button>
