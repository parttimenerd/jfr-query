...
- Name: plot-interactions.spec.ts >> Plot: AXIS_Y FORMAT >> AF1. AXIS_Y FORMAT ".2f" renders tick labels with decimal point
- Location: e2e/plot-interactions.spec.ts:1720:3

# Error details

```
Error: Y axis ticks formatted with decimal places
                  ...
                  - generic [ref=e907]:
                    - generic [ref=e908] [cursor=pointer]:
                      ...
                      - generic [ref=e912]:
                        ...
                        - generic "Query execution time" [ref=e914]: 16ms
                  ...
                  - generic [ref=e1125]:
                    - generic [ref=e1126] [cursor=pointer]:
                      ...
                      - generic [ref=e1130]:
                        ...
                        - generic "Query execution time" [ref=e1132]: 60ms
                    ...
                    - generic [ref=e1134]:
                      ...
                      - button "Delete query block" [ref=e1152]:
                        - img [ref=e1153]
                  - textbox [ref=e1159]:
                    - generic [ref=e1160]: SELECT startTime, duration_ms FROM (SELECT *, duration * 1000 AS duration_ms FROM GarbageCollection) gc ORDER BY startTime LIMIT 15
                - generic [ref=e1163]:
                  - button "+ SQL" [ref=e1164]
                  - button "+ Plot" [ref=e1165]
                  - button "+ Prose" [ref=e1166]
                - generic [ref=e1167]:
                  - generic [ref=e1168]:
                    - generic [ref=e1169] [cursor=pointer]:
                      - img [ref=e1170]
                      - generic [ref=e1172]: Plot 1
                      - generic [ref=e1173]: LINE_CHART(x:"startTime", y:["duration_ms"]) TITLE "AXIS_Y F
                    - generic [ref=e1174]:
                      - button "Format plot" [ref=e1175]:
                        - img [ref=e1176]
                      - button "Generate plot config with AI" [ref=e1179]:
                        - img [ref=e1180]
                      - button "Refine with AI" [ref=e1182]:
                        - img [ref=e1183]
                      - button "Plot syntax reference" [ref=e1186]:
                        - img [ref=e1187]
                      - button "Delete plot block" [ref=e1189]:
                        - img [ref=e1190]
                  - generic [ref=e1192]:
                    - generic [ref=e1193]:
                      - generic [ref=e1194]: "columns:"
                      - button "startTime" [ref=e1195]
                      - button "duration_ms" [ref=e1196]
                      - generic [ref=e1197]: — click to copy
                    - textbox [active] [ref=e1202]:
                      - generic [ref=e1203]: LINE_CHART(x:"startTime", y:["duration_ms"])
                      - generic [ref=e1204]: TITLE "AXIS_Y FORMAT"
                      - generic [ref=e1205]:
                        - generic [ref=e1206]: AXIS_Y
                        - generic [ref=e1207]: LABEL
                        - text: "\"ms\""
                        - generic [ref=e1208]: FORMAT
                        - text: "\".2f\""
                - generic [ref=e1210]:
                  - button "Download as PNG" [ref=e1211]:
                    - img [ref=e1212]
                  - generic [ref=e1218]:
                    - heading "AXIS_Y FORMAT" [level=4] [ref=e1219]
                    - generic [ref=e1223]:
                      - generic [ref=e1224]:
                      ...
                      - generic [ref=e1227]:
                        - list [ref=e1229]:
                          - listitem [ref=e1230]:
                            - img "duration ms legend icon" [ref=e1231]
                            - text: duration ms
                        - application [ref=e1233]:
                          - generic [ref=e1248]:
                            - generic [ref=e1249]:
                              - generic [ref=e1251]: 11:00:01.20
                              - generic [ref=e1253]: 11:00:16.20
                              - generic [ref=e1255]: 11:00:31.20
                              - generic [ref=e1257]: 11:00:46.20
                              - generic [ref=e1259]: 11:00:51.60
                            - generic [ref=e1260]:
                              - generic [ref=e1262]: "0.00"
                              - generic [ref=e1264]: "50.00"
                              - generic [ref=e1266]: "100.00"
                              - generic [ref=e1268]: "150.00"
                              - generic [ref=e1270]: "200.00"
                            - generic [ref=e1271]: ms
                - generic [ref=e1272]:
                  - button "Add variable" [ref=e1273]:
                    - img [ref=e1274]
                    - text: Add variable
                  - button "Add Plot" [ref=e1276]:
                    - img [ref=e1277]
                    - text: Add Plot
                  - button "Add SQL" [ref=e1279]:
                    - img [ref=e1280]
                    - text: Add SQL
                - generic "Drag to resize results" [ref=e1282]
              - button "Add Conclusion" [ref=e1284]:
                - img [ref=e1285]
                - text: Add Conclusion
          - generic [ref=e1287]:
            - generic [ref=e1288]:
              - generic [ref=e1289]:
                - button "Drag to reorder cell" [ref=e1290]:
                  - img [ref=e1291]
                - button "Collapse cell" [ref=e1293]:
                  - img [ref=e1294]
                - heading "Step 4 — Add your own analysis" [level=2] [ref=e1296] [cursor=pointer]
              - generic [ref=e1297]:
                - button "Raw Markdown" [ref=e1298]:
                  - img [ref=e1299]
                - button "Delete Cell" [ref=e1301]:
                  - img [ref=e1302]
            - generic [ref=e1304]:
              - list [ref=e1309] [cursor=pointer]:
                - listitem [ref=e1310]:
                  - text: Click
                  - strong [ref=e1311]: + Add SQL
                  - text: below any cell to add another query, or
                  - strong [ref=e1312]: + Add Cell
                  - text: at the bottom to start fresh.
                - listitem [ref=e1313]:
                  - text: Click
                  - strong [ref=e1314]: Plot syntax
                ...
                - listitem [ref=e1317]:
                  - text: Try the
                  - strong [ref=e1318]: Schema Explorer
                  - text: on the left — click a table to preview it, or search for a column name across all tables.
                - listitem [ref=e1319]:
                  - text: Open
                  - strong [ref=e1320]: New from template
                  - text: in the toolbar for ready-made GC, allocation, threading, and exception notebooks.
              - generic [ref=e1322]:
                - button "Add variable" [ref=e1323]:
                  - img [ref=e1324]
                  - text: Add variable
                - button "Add Plot" [ref=e1326]:
                  - img [ref=e1327]
                  - text: Add Plot
                - button "Add SQL" [ref=e1329]:
                  - img [ref=e1330]
                  - text: Add SQL
              - button "Add Conclusion" [ref=e1333]:
                - img [ref=e1334]
                - text: Add Conclusion
          - generic [ref=e1336]:
            - generic [ref=e1337]:
              - generic [ref=e1338]:
                - button "Drag to reorder cell" [ref=e1339]:
                  - img [ref=e1340]
                - button "Collapse cell" [ref=e1342]:
                  - img [ref=e1343]
                - heading "New Cell" [level=2] [ref=e1345] [cursor=pointer]
              - generic [ref=e1346]:
                - button "Raw Markdown" [ref=e1347]:
                  - img [ref=e1348]
                - button "Delete Cell" [ref=e1350]:
                  - img [ref=e1351]
            - generic [ref=e1353]:
              - button "Add Introduction" [ref=e1355]:
                - img [ref=e1356]
                - text: Add Introduction
              - generic [ref=e1359]:
                - button "Add variable" [ref=e1360]:
                  - img [ref=e1361]
                  - text: Add variable
                - button "Add Plot" [ref=e1363]:
                  - img [ref=e1364]
                  - text: Add Plot
                - button "Add SQL" [ref=e1366]:
                  - img [ref=e1367]
                  - text: Add SQL
              - button "Add Conclusion" [ref=e1370]:
                - img [ref=e1371]
                - text: Add Conclusion
          - button "Add Cell" [ref=e1374]:
            - img [ref=e1375]
            - text: Add Cell
      - generic:
        - generic:
          - generic:
            ...
            - generic:
              - generic:
                ...
                - button [disabled]:
                  - img
      - button "Expand Assistant" [ref=e1377]:
        - img [ref=e1378]
...
```ts
  1654 | test.describe.serial('Plot: PALETTE clause', () => {
  1655 |   test.skip(SKIP, 'SKIP_E2E=1 set');
  1656 | 
  1657 |   let page: Page;
  1658 | 
  1659 |   test.beforeAll(async ({ browser }) => {
  1660 |     page = await browser.newPage();
  1661 |     await gotoDemo(page);
  1662 |   });
  1663 | 
  1664 |   test.afterAll(async () => page.close());
  1665 | 
  1666 |   test('PL1. PALETTE "dark2" produces non-default bar fill colour', async () => {
  1667 |     await page.getByRole('button', { name: /Add Cell/i }).last().click();
  1668 |     await page.waitForTimeout(500);
  1669 | 
  1670 |     const sqlEd = await getLastSqlEditor(page);
  1671 |     if (!sqlEd) { test.skip(); return; }
  1672 |     await setCmContent(page, sqlEd,
  1673 |       `SELECT cause, COUNT(*) AS cnt FROM GarbageCollection GROUP BY cause`);
  1674 |     await pressRun(page);
  1675 |     await page.waitForTimeout(1500);
  1676 | 
  1677 |     const plotEd = await getLastPlotEditor(page);
  1678 |     if (!plotEd) { test.skip(); return; }
  1679 |     await setCmContent(page, plotEd,
  1680 |       'BAR_CHART(x:"cause", y:["cnt"])\n  TITLE "Palette dark2"\n  PALETTE "dark2"');
  1681 |     await pressRun(page);
  1682 |     await page.waitForTimeout(2000);
  1683 | 
  1684 |     const container = page.locator('div[id^="result-container-"]').last();
  1685 |     await expect(container).toBeVisible({ timeout: 10_000 });
  1686 |     const hasError = await page.evaluate(() =>
  1687 |       [...document.querySelectorAll('*')].some(el => el.textContent === 'Plot render error')
  1688 |     );
  1689 |     expect(hasError).toBe(false);
  1690 | 
  1691 |     // dark2 first colour is #1b9e77 — not the default category10 #8884d8
  1692 |     const fill = await page.evaluate(() => {
  1693 |       const cs = [...document.querySelectorAll('div[id^="result-container-"]')];
  1694 |       const c = cs[cs.length - 1];
  1695 |       if (!c) return null;
  1696 |       const rect = c.querySelector('.recharts-bar-rectangle path, .recharts-rectangle');
  1697 |       return rect ? (rect as SVGElement).getAttribute('fill') : null;
  1698 |     });
  1699 |     expect(fill, 'palette fill applied').not.toBe('#8884d8');
  1700 |     expect(fill, 'fill is truthy').toBeTruthy();
  1701 |   });
  1702 | });
  1703 | 
  1704 | // ---------------------------------------------------------------------------
  1705 | // Section 32: AXIS_Y FORMAT
  1706 | // ---------------------------------------------------------------------------
  1707 | 
  1708 | test.describe.serial('Plot: AXIS_Y FORMAT', () => {
  1709 |   test.skip(SKIP, 'SKIP_E2E=1 set');
  1710 | 
  1711 |   let page: Page;
  1712 | 
  1713 |   test.beforeAll(async ({ browser }) => {
  1714 |     page = await browser.newPage();
  1715 |     await gotoDemo(page);
  1716 |   });
  1717 | 
  1718 |   test.afterAll(async () => page.close());
  1719 | 
  1720 |   test('AF1. AXIS_Y FORMAT ".2f" renders tick labels with decimal point', async () => {
  1721 |     await page.getByRole('button', { name: /Add Cell/i }).last().click();
  1722 |     await page.waitForTimeout(500);
  1723 | 
  1724 |     const sqlEd = await getLastSqlEditor(page);
  1725 |     if (!sqlEd) { test.skip(); return; }
  1726 |     await setCmContent(page, sqlEd,
  1727 |       `SELECT startTime, duration_ms FROM (SELECT *, duration * 1000 AS duration_ms FROM GarbageCollection) gc ORDER BY startTime LIMIT 15`);
  1728 |     await pressRun(page);
  1729 |     await page.waitForTimeout(1500);
  1730 | 
  1731 |     const plotEd = await getLastPlotEditor(page);
  1732 |     if (!plotEd) { test.skip(); return; }
  1733 |     await setCmContent(page, plotEd,
  1734 |       'LINE_CHART(x:"startTime", y:["duration_ms"])\n  TITLE "AXIS_Y FORMAT"\n  AXIS_Y LABEL "ms" FORMAT ".2f"');
  1735 |     await pressRun(page);
  1736 |     await page.waitForTimeout(2000);
  1737 | 
  1738 |     const container = page.locator('div[id^="result-container-"]').last();
  1739 |     await expect(container).toBeVisible({ timeout: 10_000 });
  1740 | 
  1741 |     const hasError = await page.evaluate(() =>
  1742 |       [...document.querySelectorAll('*')].some(el => el.textContent === 'Plot render error')
  1743 |     );
  1744 |     expect(hasError).toBe(false);
  1745 | 
  1746 |     // ".2f" format produces tick labels with a decimal point (e.g. "25.00", "50.00")
  1747 |     const hasFormattedTick = await page.evaluate(() => {
  1748 |       const cs = [...document.querySelectorAll('div[id^="result-container-"]')];
  1749 |       const c = cs[cs.length - 1];
  1750 |       if (!c) return false;
  1751 |       const ticks = [...c.querySelectorAll('.recharts-yAxis .recharts-cartesian-axis-tick-value, .recharts-yAxis text')];
  1752 |       return ticks.some(t => /\d+\.\d+/.test(t.textContent ?? ''));
  1753 |     });
> 1754 |     expect(hasFormattedTick, 'Y axis ticks formatted with decimal places').toBe(true);
       |                                                                            ^ Error: Y axis ticks formatted with decimal places
  1755 |   });
  1756 | });
  1757 | 
  1758 | // ---------------------------------------------------------------------------
  1759 | // Section 33: BAR_CHART lineY overlay
  1760 | // ---------------------------------------------------------------------------
  1761 | 
  1762 | test.describe.serial('Plot: BAR_CHART lineY overlay', () => {
  1763 |   test.skip(SKIP, 'SKIP_E2E=1 set');
  1764 | 
  1765 |   let page: Page;
  1766 | 
  1767 |   test.beforeAll(async ({ browser }) => {
  1768 |     page = await browser.newPage();
  1769 |     await gotoDemo(page);
  1770 |   });
  1771 | 
  1772 |   test.afterAll(async () => page.close());
  1773 | 
  1774 |   test('BL1. BAR_CHART with lineY renders both bar and line series', async () => {
  1775 |     await page.getByRole('button', { name: /Add Cell/i }).last().click();
  1776 |     await page.waitForTimeout(500);
  1777 | 
  1778 |     const sqlEd = await getLastSqlEditor(page);
  1779 |     if (!sqlEd) { test.skip(); return; }
  1780 |     await setCmContent(page, sqlEd,
  1781 |       `SELECT cause, COUNT(*) AS cnt, AVG(duration_ms) AS avg_ms
  1782 |        FROM (SELECT *, duration * 1000 AS duration_ms FROM GarbageCollection) gc GROUP BY cause ORDER BY cnt DESC LIMIT 5`);
  1783 |     await pressRun(page);
  1784 |     await page.waitForTimeout(1500);
  1785 | 
  1786 |     const plotEd = await getLastPlotEditor(page);
  1787 |     if (!plotEd) { test.skip(); return; }
  1788 |     await setCmContent(page, plotEd,
  1789 |       'BAR_CHART(x:"cause", y:["cnt"], lineY:["avg_ms"])\n  TITLE "BAR with lineY"');
  1790 |     await pressRun(page);
  1791 |     await page.waitForTimeout(2000);
  1792 | 
  1793 |     const container = page.locator('div[id^="result-container-"]').last();
  1794 |     await expect(container).toBeVisible({ timeout: 10_000 });
  1795 | 
  1796 |     const hasError = await page.evaluate(() =>
  1797 |       [...document.querySelectorAll('*')].some(el => el.textContent === 'Plot render error')
  1798 |     );
  1799 |     expect(hasError).toBe(false);
  1800 | 
  1801 |     // Both a bar series and a line series should be rendered
  1802 |     const hasBars = await container.locator('.recharts-bar').count();
  1803 |     const hasLine = await container.locator('.recharts-line').count();
  1804 |     expect(hasBars, 'bar series rendered').toBeGreaterThan(0);
  1805 |     expect(hasLine, 'line overlay rendered').toBeGreaterThan(0);
  1806 |   });
  1807 | });
  1808 | 
  1809 | // ---------------------------------------------------------------------------
  1810 | // Section 34: LET @constant in plot expressions
  1811 | // ---------------------------------------------------------------------------
  1812 | 
  1813 | test.describe.serial('Plot: LET @constant', () => {
  1814 |   test.skip(SKIP, 'SKIP_E2E=1 set');
  1815 | 
  1816 |   let page: Page;
  1817 | 
  1818 |   test.beforeAll(async ({ browser }) => {
  1819 |     page = await browser.newPage();
  1820 |     await gotoDemo(page);
  1821 |   });
  1822 | 
  1823 |   test.afterAll(async () => page.close());
  1824 | 
  1825 |   test('LC1. LET @name = value substitutes constant in tail clauses', async () => {
  1826 |     await page.getByRole('button', { name: /Add Cell/i }).last().click();
  1827 |     await page.waitForTimeout(500);
  1828 | 
  1829 |     const sqlEd = await getLastSqlEditor(page);
  1830 |     if (!sqlEd) { test.skip(); return; }
  1831 |     await setCmContent(page, sqlEd,
  1832 |       `SELECT startTime, duration_ms FROM (SELECT *, duration * 1000 AS duration_ms FROM GarbageCollection) gc ORDER BY startTime LIMIT 10`);
  1833 |     await pressRun(page);
  1834 |     await page.waitForTimeout(1500);
  1835 | 
  1836 |     const plotEd = await getLastPlotEditor(page);
  1837 |     if (!plotEd) { test.skip(); return; }
  1838 |     await setCmContent(page, plotEd,
  1839 |       'LINE_CHART(x:"startTime", y:["duration_ms"])\n  TITLE "LET Test"\n  LET @thresh = 50\n  AXIS_Y DOMAIN [0, @thresh]');
  1840 |     await pressRun(page);
  1841 |     await page.waitForTimeout(2000);
  1842 | 
  1843 |     const container = page.locator('div[id^="result-container-"]').last();
  1844 |     await expect(container).toBeVisible({ timeout: 10_000 });
  1845 | 
  1846 |     const hasError = await page.evaluate(() =>
  1847 |       [...document.querySelectorAll('*')].some(el => el.textContent === 'Plot render error')
  1848 |     );
  1849 |     expect(hasError).toBe(false);
  1850 | 
  1851 |     // With AXIS_Y DOMAIN [0, 50] the Y axis max tick should be ≤ 50
  1852 |     const maxTick = await page.evaluate(() => {
  1853 |       const cs = [...document.querySelectorAll('div[id^="result-container-"]')];
  1854 |       const c = cs[cs.length - 1];
```