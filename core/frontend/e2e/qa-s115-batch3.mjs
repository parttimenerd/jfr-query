/**
 * S115 batch 3: Exceptions & Errors + Threading & Contention + GC Analysis + Comprehensive Feature Test
 */
...
(async () => {
  ...
  for (const name of ['Exceptions & Errors', 'Threading & Contention', 'GC Pause Analysis', 'Comprehensive Feature Test']) {
    console.log(`\nLoading: ${name}`);
