/**
 * S119 batch-B: Recording Overview + CPU Profiling + Heap Allocation + I/O & Latency + Exceptions & Errors
 */
...
(async()=>{
  ...
  for(const name of['Recording Overview','CPU Profiling','Heap Allocation','I/O & Latency','Exceptions & Errors']){
    console.log(`\nLoading: ${name}`);
