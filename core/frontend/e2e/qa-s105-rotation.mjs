/**
 * S105 template rotation: Container & Cloud + Comprehensive Feature Test
 */
...
(async()=>{
  ...
  for(const name of ['Container & Cloud','Comprehensive Feature Test']){
    console.log(`\nLoading: ${name}`);
