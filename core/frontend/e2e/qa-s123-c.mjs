/**
 * S123 batch-C: Memory Leak Detection + ZGC Analysis + GC Deep Dive + Comprehensive Feature Test
 */
...
(async()=>{
  ...
  for(const name of['Memory Leak Detection','ZGC Analysis','GC Deep Dive','Comprehensive Feature Test']){
    console.log(`\nLoading: ${name}`);
