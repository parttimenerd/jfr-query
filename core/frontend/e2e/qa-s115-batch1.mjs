/**
 * S115 batch 1: Recording Overview + CPU Profiling + Heap Allocation + I/O & Latency
 */
...
(async () => {
  ...
  for (const name of ['Recording Overview', 'CPU Profiling', 'Heap Allocation', 'I/O & Latency']) {
    console.log(`\nLoading: ${name}`);
