/**
 * S123 batch-A: demo + full interactive + GC Pause Analysis + Recording Overview + CPU Profiling + I/O & Latency
 */
...
(async()=>{
  ...
  // ── TEMPLATES ──
  for(const name of['Recording Overview','CPU Profiling','I/O & Latency']){
    console.log(`\n══ ${name.toUpperCase()} ══`);
