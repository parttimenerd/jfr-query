...
public class ViewsTest {
    ...
    private JFRFileHelper getJFRFileHelper(JFRFile jfrFile) {
        return jfrFileHelpers.computeIfAbsent(
                jfrFile,
                jf -> {
                    try {
        ...
        return Stream.of(
                ...
                new ExpectedView(
                        ...
                        """
                                ...
                                2025-09-29 18:10:55.18196,86.50ms,org.renaissance.harness.ExecutionPlugins$ForceGcPlugin.collectGarbage(Ljava/lang/String;)V
                                ...
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                ...
                new ExpectedView(
                        ...
                        JFRFile.METAL),
                new ExpectedView(
                        "contention-by-address", // maybe check why if differs from JFR
                        """
                ...
                new ExpectedView(
                        ...
                        JFRFile.METAL),
                new ExpectedView(
                        "exception-by-type", // TODO: check why different from JFR
                        """
                                Class,Count
                                java.lang.ClassNotFoundException,5235
                                java.lang.NoSuchMethodError,1298
                                java.io.EOFException,940
                                ...
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                ...
                new ExpectedView(
                        ...
                        """
                                ...
                                java.lang.invoke.MemberName$Factory.resolve(BLjava/lang/invoke/MemberName;Ljava/lang/Class;IZ)Ljava/lang/invoke/MemberName;,1018
                                java.io.ObjectInputStream$BlockDataInputStream.peekByte()B,937
                                ...
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                ...
                new ExpectedView(
                        ...
                        """
                                ...
                                G1New,G1Old,83,21,true,false,false,0s,12
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                        "gc-references",
                        ...
                        JFRFile.METAL),
                new ExpectedView(
                        "gc-pause-phases", // TODO: check why different from JFR
                        """
                ...
                new ExpectedView(
                        ...
                        JFRFile.METAL),
                new ExpectedView(
                        "memory-leaks-by-class", // TODO: check why different from JFR
                        """
                                ...
                                2025-09-29 18:10:03.988608,java.lang.ClassValue.Entry[],82.00s,462.39 MB
                                ...
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                ...
                new ExpectedView(
                        ...
                        """
                                Method,Samples,Percent
                                sun.nio.ch.EPoll.wait(IJII)I,1300,55.15%
                                sun.nio.fs.LinuxWatchService.poll(II)I,693,29.40%
                                java.util.zip.Inflater.inflateBytesBytes(J[BII[BII)J,113,4.79%
                                ...
                                """,
                        JFRFile.METAL),
                new ExpectedView(
                ...
                new ExpectedView(
                        ...
                        JFRFile.CONTAINER),
                new ExpectedView(
                        "object-statistics", // TODO: check why different from JFR
                        """
    ...
    public void testViewOutput(ExpectedView expectedView)
        ...
        executor.executeQuery(
                "SELECT * FROM \"" + expectedView.view + "\"",
                QueryExecutor.OutputFormat.CSV,
                printStream);
        printStream.flush();
        ...
        if (expected.endsWith("...")) {
            ...
            result =
                    result.length() > expected.length()
                            ? result.substring(0, expected.length())
                            : result;
        }
        Assertions.assertEquals(
                expected, result, "View output does not match for view: " + expectedView.view);
    }
}
